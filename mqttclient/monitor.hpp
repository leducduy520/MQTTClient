 ...
 *
 * This header defines the ddbg::Printer class for formatted logging with support for:
...
namespace ddbg
{
    ...
    class Printer
    {
        ...
        string modeprefix_;        ///< Prefix to denote the log message type (Error, Info, Debug).
    ...
    public:
         ...
         *
         * Uses a stringstream to convert data to string and appends it to the log message.
         *
         ...
         *
         * Applies the provided stream manipulator, prints the log message, and outputs it.
         *
...
#define ddebug1(msg, ...) DDBG_PRINTER::format(msg, ##__VA_ARGS__).DDBG_AS_DEBUG.DDBG_DETAIL_LEVEL_1
    /// Macro for debug-level logging with timestamp and line info.
#define ddebug2(msg, ...) DDBG_PRINTER::format(msg, ##__VA_ARGS__).DDBG_AS_DEBUG.DDBG_DETAIL_LEVEL_2
#else
...
#define dinfo1(msg, ...) DDBG_PRINTER::format(msg, ##__VA_ARGS__).DDBG_AS_INFO.DDBG_DETAIL_LEVEL_1
    /// Macro for informational logging with timestamp and line info.
#define dinfo2(msg, ...) DDBG_PRINTER::format(msg, ##__VA_ARGS__).DDBG_AS_INFO.DDBG_DETAIL_LEVEL_2
...
#define derror1(msg, ...) DDBG_PRINTER::format(msg, ##__VA_ARGS__).DDBG_AS_ERROR.DDBG_DETAIL_LEVEL_1
    /// Macro for error logging with timestamp and line info.
#define derror2(msg, ...) DDBG_PRINTER::format(msg, ##__VA_ARGS__).DDBG_AS_ERROR.DDBG_DETAIL_LEVEL_2
